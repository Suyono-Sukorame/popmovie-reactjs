...
export default function StarRating({ max = 5, color = "#fcc419", size = 48, messages = [], defaultRating = 0 }) {
  ...
  return (
    <div style={containerStyle}>
      ...
      <p style={textStyle}>{messages.length === max ? messages[tempRating ? tempRating - 1 : rating - 1] : tempRating || rating || ""}</p>
    </div>
  );
}
